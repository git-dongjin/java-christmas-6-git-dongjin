...
class DiscountPresentPolicyTest {
    private static final String LINE_SEPARATOR = System.lineSeparator(),
            ...
            PRESENTS_DETAILS_NOT_AVAILABLE = "<증정 메뉴>" + LINE_SEPARATOR + "없음" + LINE_SEPARATOR,
            ...
            PROFIT_DETAILS_NOT_AVAILABLE = "<혜택 내역>" + LINE_SEPARATOR + "없음" + LINE_SEPARATOR;
    ...
    void presentsDetails_최소주문금액미만() {
        ...
        assertThat(discountPresentPolicy.presentsDetails()).isEqualTo(PRESENTS_DETAILS_NOT_AVAILABLE);
    ...
    void profitDetails_최소주문금액미만() {
        ...
        assertThat(discountPresentPolicy.profitDetails()).isEqualTo(PROFIT_DETAILS_NOT_AVAILABLE);
